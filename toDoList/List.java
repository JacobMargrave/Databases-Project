...
//			con.setAutoCommit(true);
	...
	public void setupDatabaseConnection(String sshUser, String sshPassword, String dbUser, String dbPassword, String remotePort) {
...
//			e.printStackTrace();
	...
	private Session doSshTunnel( String strSshUser, String strSshPassword, String strSshHost, int nSshPort, String strRemoteHost, int nLocalPort, int nRemotePort ) throws JSchException
	{
	...
	public static void main (String[] args) throws SQLException{
		...
		if (args.length<5){
			...
			try {
				Shell shell = ShellFactory.createConsoleShell("TO-DO", "TO-DO List...\n"+"Enter ?list to list available commands.\n", list);
				shell.commandLoop();
			} catch (IOException e) {
